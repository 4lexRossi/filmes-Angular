...
@Component({
  selector: 'fpt-pre-cadastro-fpt',
  templateUrl: './pre-cadastro-fpt.component.html',
  styleUrls: ['./pre-cadastro-fpt.component.scss']
})
export class PreCadastroFptComponent implements OnInit {
