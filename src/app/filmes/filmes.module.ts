...
@NgModule({
  ...
  declarations: [CadastroFilmesComponent, ListagemFilmesComponent, VisualizarFilmesComponent, ListagemCampanhasComponent, CriarCampanhaComponent, VisualizarCampanhaComponent, PreCadastroComponent]
})
